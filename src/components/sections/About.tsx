...
const ABOUT_FALLBACK_TEXT = [
  ...
  "Для меня стиль — это самовыражение, а не слепое следование трендам: всегда отталкиваюсь от личности клиента, его образа жизни и задач. Работаю в двух направлениях — персональный стиль (гардероб, шопинг, образы) и съёмочные проекты, от концепции до полной организации.",
].join("\n\n");
