    ...
    >
      <div className="flex flex-col md:w-[54rem] md:flex-row md:items-center">
        {/* Кадр: сверху на мобильном, слева на десктопе.
            Десктоп — колонка во всю высоту окна (self-stretch + aspect-auto),
            без полей сверху и снизу. Колонка при этом уже своей высоты
            (примерно 0.56 против 4:5), поэтому вертикальный кадр обрезается
            по бокам примерно на треть — про это сказано в подсказке поля в
            Studio: важное нужно держать по центру.
        ...
        <div className="bg-placeholder relative aspect-[4/5] max-h-[42svh] w-full md:aspect-auto md:max-h-none md:w-[44%] md:shrink-0 md:self-stretch">
          <Image
