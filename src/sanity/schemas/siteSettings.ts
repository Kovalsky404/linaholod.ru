...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        "Вертикальный кадр в пропорции 4:5 (например 1600×2000). В окне он " +
        "занимает колонку во всю высоту, которая уже 4:5, поэтому по бокам " +
        "обрежется примерно треть — держите важное по центру кадра. Другие " +
        "пропорции вёрстку не сломают. Пока фото не залито, показывается " +
        "серая заглушка.",
      type: "image",
      options: { hotspot: true },
      group: "certificates",
